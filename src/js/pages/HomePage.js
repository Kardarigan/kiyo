    ...
    this.container.innerHTML = `
      <section class="home-hero">
        <div class="hero-content">
          ...
          <blockquote class="hero-quote body-large text-muted">"${DomHelper.escapeHtml(
            homeData.heroQuote
          )}"</blockquote>
        </div>
        <div class="hero-image">
          <div class="image-frame">
            <img src="/images/korekiyo/${DomHelper.escapeHtml(
              homeData.featuredImage
            )}" alt="${DomHelper.escapeHtml(
      character.name
    )} portrait" class="portrait-main" loading="eager">
          </div>
        </div>
      </section>
      <section class="home-intro">
        <div class="intro-card card">
          <p class="body-large">${DomHelper.escapeHtml(character.bio.short)}</p>
        </div>
      </section>
      ${
        homeData.sections
          ? homeData.sections
              .map((section) => {
                if (section.type === "quote") {
                  return `<section class="home-quote-section"><blockquote class="accent-quote"><p class="body-text">"${DomHelper.escapeHtml(
                    section.content
